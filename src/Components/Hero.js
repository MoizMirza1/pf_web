      ...
      <div className="container mx-auto h-full text-white">
        <div className="flex items-center h-full pt-8">
          ...
          <div className="flex flex-1 flex-col items-center lg:items-start">
            <p className="text-accent lg:text-xl mb-[22px] text-2xl ">
              Hey, I'm Moiz 👋
            </p>
            <h1 className="text-4xl md:text-5xl leading-[44px] font-bold mb-[22px] md:leading-tight lg:leading-[1.2]">
              I'm a MERN Stack Developer{" "}
            </h1>
            <p className="text-[15px] mb-[22px] text-gray-300">
              I Build & Design Web Interfaces I have a passion for web
          ...
          <div className="hidden lg:flex flex-1 justify-end items-end h-full  ">
            <img
              className="lg:w-[550px] w-[450px] bg-accent-500 shadow-xl shadow-green-500/100  rounded-lg ring-2 ring-offset-1  contrast-150 saturate-150 "
              src={Myimg}
              alt="heroimg"
            />
          </div>
